...
function nodoError(error) {
    console.log("lib.nodo: NODO ERROR: " + error);
}
function connectNodo() {
    nodo = new net.Socket();
    nodo.connect(nodoport, nodoname, function(){
        console.log("lib.nodo: Connected to: " + nodoname + ":" + nodoport);
        nodo.write('\n');
    ...
    checkinterval = setInterval(function(){
        if (nodo.writable === false) {
            console.log('lib.nodo: nodo lost, reconnecting...');
...
var nodolib = {
    write: function(data) {
        console.log('lib.nodo: WRITIIING!!');
    ...
    kaku: function(cmd) {
        ...
        console.log('lib.nodo: KAKU COMMAND: ' + command);
